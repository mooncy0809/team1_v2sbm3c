...
<link
    href="https://fonts.googleapis.com/css2?family=Alfa+Slab+One&family=Anton&family=Do+Hyeon&family=Gaegu:wght@300&family=Kdam+Thmor+Pro&family=Kirang+Haerang&family=Nanum+Gothic&display=swap"
    rel="stylesheet">
<style type="text/css">
#menubar:hover {
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a id="menubar"
                                    href="../index.do"
                                    style="color: balck; background-color: #FFF2EE;"}>삼대몇?</a></li>
                                <li><a id="menubar"
                                    href="../index2.do">하루삼끼</a></li>
                            </ul>
                        </div>
                    </div>
                                                ...
                                                <ul role="menu"
                                                    ...
                                                    <li
                                                        ...
                                                        <ul role="menu"
                                                            ...
                                                            id="sub_com3">
                                                            <li><a
                                                                href="/categrp/list.do">카테고리
                                                                    관리</a></li>
                                                            <br>
                                                            <li><a
                                                                href="../you/list_by_categrpno_search_paging.do?categrpno=4">홈트레이닝
                                                                    관리</a></li>
                                                        </ul></li>
                                                    <li
                                                        class="dropdown2"><a
                                                        ...
                                                        <ul role="menu"
                                                            ...
                                                            id="sub_com4">
                                                            <li><a
                                                                href="/categrp/list2.do">카테고리
                                                                    관리</a></li>
                                                            <br>
                                                            <li><a
                                                                href="/categrp/list.do">주문
                                                                    관리</a></li>
                                                        </ul></li>
                ...
                <div id="mySidenav" class="sidenav category-bg"
                    ...
                    <li class="menu" style="list-style: none;">
                        <ul>
                            ...
                            <a href="../contents/tip_by_cateno.do"><li>DIET
                                    TIP</li></a>
                            <a onclick="com(this)"><li>COMMUNITY</li></a>
                            <div class="sub_com" id="sub_com"
                                style="display: none;">
                                <a href="../contents/list_all_join.do"><li>전체</li></a>
                                <a
                                    href="../contents/list_by_cateno_search_paging.do?cateno=4&now_page=1"><li>자유게시판</li></a>
                                <a
                                    href="../contents/list_by_cateno_search_paging.do?cateno=5&now_page=1"><li>팁&노하우</li></a>
                                <a
                                    href="../contents/list_by_cateno_search_paging.do?cateno=6&now_page=1"><li>고민&질문</li></a>
                                <a
                                    href="../contents/list_by_cateno_search_paging.do?cateno=7&now_page=1"><li>일기</li></a>

                                <a
                                    href="/qna/list_search_paging.do?categrpno=6&memberno=${sessionScope.memberno}">
                                    <li>관리자에게</li>
                                </a> 

                            </div>
                            <a
                                href="../you/list_by_categrpno_grid_search_paging.do?categrpno=4&now_page=1"><li>HOME
                                    TRAINING</li></a>
                            <a
                                href="../dict/list_by_categrpno_search_paging.do?categrpno=5"><li>CALORIE
                                    DICTIONARY</li></a>
                        </ul>
                    </li>
                </div>
