    ...
    <ul>
      <li class="li_none">
        <DIV style='text-align: center; width: 50%; float: left;'>
          <c:set var="pfile1saved" value="${productVO.pfile1saved.toLowerCase() }" />
        ...
        <DIV style='text-align: left; width: 47%; float: left;'>
          <span style='font-size: 1.5em;'>${ptitle}</span>
          <br>
          <FORM name='frm' method='POST' action='./update_file.do' enctype="multipart/form-data">
            <input type="hidden" name="productno" value="${productno }">
            <input type="hidden" name="now_page" value="${param.now_page }">
            <input type="hidden" name="pword" value="${param.pword }">
                
            <br><br> 
            변경 이미지 선택<br>  
            <input type='file' name='pfile1MF' id='pfile1MF' value='' placeholder="파일 선택"><br>
            패스워드<br>
            <input type='password' name='ppasswd' value='' required="required" style='width: 30%;'>
            <br>
