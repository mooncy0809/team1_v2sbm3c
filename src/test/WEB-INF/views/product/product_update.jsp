...
<DIV class='content_body'>
  <FORM name='frm' method='POST' action='./product_update.do' class="form-horizontal">
    ...
    <div class="form-group">
       ...
       <div class="col-md-10">
         <input type='number' name='price' value='${productVO.price }' required="required" autofocus="autofocus"
    ...
    <div class="form-group">
       ...
       <div class="col-md-10">
         <input type='number' name='dc' value='${productVO.dc }' required="required"
    ...
    <div class="form-group">
       ...
       <div class="col-md-10">
         <input type='number' name='saleprice' value='${productVO.saleprice }' required="required"
                    min="0" max="10000000" step="100" 
                    class="form-control" style='width: 100%;'>
       </div>
    </div>         
    <div class="form-group">
       ...
       <div class="col-md-10">
         <input type='number' name='point' value='${productVO.point }' required="required"
    ...
    <div class="form-group">
       ...
       <div class="col-md-10">
         <input type='number' name='salecnt' value='${productVO.salecnt }' required="required" 
                    min="0" max="99999" step="1" class="form-control" style='width: 100%;'>
    </div>
    </div>
    <div class="content_body_bottom">
      <button type="submit" class="btn btn-primary">저장</button>
      <button type="button" onclick="location.href='./read.do?cateno=${param.cateno}&contents=${param.productno }'" class="btn btn-primary">취소</button>
    </div>
