...
<DIV class="container">
    ...
    <form id='frm' name='frm' action='/tensorflow/recommend/end.do' method='GET'>
        ...
        <TABLE style='margin: 0px auto;'>
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/recommend/images/v15.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/recommend/images/v25.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/recommend/images/v35.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img4' src="/recommend/images/v45.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
