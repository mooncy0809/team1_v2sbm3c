...
<script type="text/javascript">
  ...
  function recom_ajax(productno, status_count) {
    console.log("-> recom_" + status_count + ": " + $('#recom_' + status_count).html());  // A tag body      
    var params = "";
    // params = $('#frm').serialize(); // 직렬화, 폼의 데이터를 키와 값의 구조로 조합
    params = 'productno=' + productno; // 공백이 값으로 있으면 안됨.
    $.ajax(
      {
        url: '/product/update_recom_ajax.do',
        type: 'post',  // get, post
    ...
    $('#recom_' + status_count).html("<img src='/product/images/ani04.gif' style='width: 10%;'>");
    // $('#span_animation_' + status_count).css('text-align', 'center');
    // $('#span_animation_' + status_count).html("<img src='/product/images/ani04.gif' style='width: 10%;'>");
