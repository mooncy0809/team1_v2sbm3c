...
<DIV class='content_body'>
  ...
  <FORM name='frm' method='POST' action='./create.do' class="form-horizontal"
    ...
    <div class="form-group">
       ...
       <div class="col-md-10">
         <input type='text' name='ptitle' value='상품 이름' required="required" 
    ...
    <div class="form-group">
       ...
       <div class="col-md-10">
         <textarea name='pcontent' required="required" class="form-control" rows="12" style='width: 100%;'>상품 내용</textarea>
       </div>
    </div>
    <div class="form-group">
       <label class="control-label col-md-2">검색어</label>
       <div class="col-md-10">
         <input type='text' name='pword' value='검색어 검색어 검색어' required="required" 
    ...
    <div class="form-group">
       ...
       <div class="col-md-10">
         <input type='file' class="form-control" name='pfile1MF' id='pfile1MF' 
    ...
    <div class="form-group">
       ...
       <div class="col-md-10">
         <input type='password' name='ppasswd' value='1234' required="required" 
                    class="form-control" style='width: 50%;'>
       </div>
    </div>   
    <div class="content_body_bottom">
      <button type="submit" class="btn btn-primary">등록</button>
      <button type="button" onclick="location.href='./list_by_cateno_search_paging_cookie_cart.do'" class="btn btn-primary">목록</button>
    </div>
