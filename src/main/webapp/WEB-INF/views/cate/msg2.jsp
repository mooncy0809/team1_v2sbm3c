    ...
    <UL>
      ...
      <LI class='li_none'>
        ...
        <c:choose>
            ...
            <c:when test="${param.cnt > 0 }">
                <button type='button' onclick="location.href='./create.do?categrpno=${param.categrpno}'" class="btn btn-info">새로운 카테고리 등록</button>
            </c:when>
        </c:choose>
        
        <button type='button' onclick="location.href='./list_all.do'" class="btn btn-info">카테고리 전체 목록</button>
        <button type='button' onclick="location.href='./list_by_categrpno2.do?categrpno=${param.categrpno}'" class="btn btn-info">목록</button>
      </LI>
    </UL>
  </fieldset>
