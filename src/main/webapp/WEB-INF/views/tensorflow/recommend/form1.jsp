...
<DIV>
    <div>
    <span style="font-family: 'Luckiest Guy', cursive; font-size:30px;">STEP 1</span>&nbsp;
    ...
    <form id='frm' name='frm' action='/tensorflow/recommend/form2.do' method='GET'>
        <br>
        <TABLE style='margin: 0px auto;'>
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/recommend/images/v11.jpg" style='float:left; height: 150px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/recommend/images/v21.jpg" style='float:left; height: 150px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/recommend/images/v31.jpg" style='float:left; height: 150px'>
                </TD>
                <TD class='td_image'>
                    <img id='img4' src="/recommend/images/v41.jpg" style='float:left; height: 150px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/recommend/images/v51.jpg" style='float:left; height: 150px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
