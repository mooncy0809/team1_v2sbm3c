...
<DIV class='content_body'>
  <DIV id='div_login' style='display: ; padding-left: 80px;'>
    <div style='width: 100%; margin: 0px 0px 0px 0px;'>
        <FORM name='frm_login' id='frm_login' method='post' action='./login2.do' class="form-horizontal">
    ...
    <div style='text-align: center; margin: 10px auto;'>
      ...
      <button type='button' onclick="location.href='./create2.do'" class="btn btn-info">회원가입</button>
      <button type='button' onclick="location.href='./find_id_form2.do'" class="btn btn-info">아이디 찾기</button>
      <button type='button' onclick="location.href='./find_passwd2.do'" class="btn btn-info">비밀번호 찾기</button>
      <button type='button' id='btn_loadDefault' class="btn btn-info">테스트 계정</button>
      <button type='button' id='btn_cancel' class="btn btn-info" onclick="location.href='../index2.do'">취소</button>
