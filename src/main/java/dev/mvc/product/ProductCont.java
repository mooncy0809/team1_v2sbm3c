...
//          System.out.println("file1: " + vo.getFile1());
     ...
     * 
     */
    @RequestMapping(value = "/product/list_by_cateno_grid_join_dc.do", method = RequestMethod.GET)
    public ModelAndView list_by_cateno_grid_join_dc(@RequestParam(value = "cateno", defaultValue = "1") int cateno,
            @RequestParam(value = "pword", defaultValue = "") String word,
            @RequestParam(value = "now_page", defaultValue = "1") int now_page,
            HttpServletRequest request) {
        ModelAndView mav = new ModelAndView();
        ...
        // 검색 목록
        List<Cate_ProductVO> list = productProc.list_by_cateno_grid_join_dc(map);
        mav.addObject("list", list);
