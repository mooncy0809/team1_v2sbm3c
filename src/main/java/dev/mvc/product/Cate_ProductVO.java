...
public class Cate_ProductVO {
    private int c_cateno;
    ...
    public Cate_ProductVO() { // 기본 생성자
        
    }

    public int getC_cateno() {
        return c_cateno;
    }

    public void setC_cateno(int c_cateno) {
        this.c_cateno = c_cateno;
    }
